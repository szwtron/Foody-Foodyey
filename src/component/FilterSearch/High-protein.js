...
const Recipe = ({recipe}) => {
    ...
    let labelhigh = recipe.recipe.dietLabels;
    //console.log(labelhigh);
    ...
    if(labelhigh[3] === "High-Protein" || labelhigh[2] === "High-Protein" || labelhigh[1] === "High-Protein" || labelhigh[0] === "High-Protein"){
        return( 
