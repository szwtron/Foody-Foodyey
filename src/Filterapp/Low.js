...
import LowRecipe from '../component/FilterSearch/Low-fat'
  ...
  return (
      ...
      <div className="LowApp">
       <div className="containerApp">
         <div className="col">
           <h1>Low-Fat Goodies</h1>
           <h2>Let's go on a DIET dude!</h2>
         ...
         <div className="recipes">
           {recipes !== [] && recipes.map(recipe => <LowRecipe key={uuidv4()}  recipe= {recipe}/>)}
         </div>
       </div>
     </div>
